...
<div class="container">
	<div class="panel panel-info">
		...
		<center><form action="<?php echo e(url('jabatan')); ?>/?kode_jabatan=kode_jabatan">
		<input type="text" name="kode_jabatan" placeholder="Cari Berdasarkan Kode">
		<input type="submit" class="btn btn-info" value="Cari">
			...
			<center><a class="btn btn-success" href="<?php echo e(url('jabatan/create')); ?>"><b>Tambah Data</b></a></center>
		</div>
	</div>
</div>
